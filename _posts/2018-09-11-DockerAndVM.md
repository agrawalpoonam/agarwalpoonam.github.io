...
|Architecture| ![Docker]({{ site.github.url }}/media/img/Architecture_Docker.png ){:height="100%" width="100%"} |![Virtual Machine]({{ site.github.url }}/media/img/Architecture_VM.png ){:height="100%" width="100%"}|
