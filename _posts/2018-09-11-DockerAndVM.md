...
|Architecture| ![Docker]({{ site.github.url }}/media/img/Architecture_VM.png ){:height="70%" width="190%"} |![Virtual Machine]({{ site.github.url }}/media/img/Architecture_VM.png ){:height="70%" width="130%"}|
