...
|Architecture| ![Docker]({{ site.github.url }}/media/img/Architecture_VM.png ){:height="70%" width="130%"} |![Virtual Machine]({{ site.github.url }}/media/img/Architecture_VM.png ){:height="70%" width="130%"}|
